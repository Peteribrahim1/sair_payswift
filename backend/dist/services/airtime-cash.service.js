...
exports.AirtimeCashService = void 0;
...
class AirtimeCashService {
     ...
     */
    static async initializeConversion(amount, network, phone, userId) {
        ...
        if (config)
            payoutRate = config.airtimeToCashRate;
        ...
        try {
            ...
            if (cheetahNetwork === 'MTN')
                cheetahNetwork = 'MTN TRANSFER';
            if (cheetahNetwork === '9MOBILE')
                cheetahNetwork = '9 MOBILE';
            // Send to CheetahPay
            ...
            const response = await axios_1.default.post('https://cheetahpay.com.ng/api/v1', payload.toString(), {
                headers: {
...
exports.AirtimeCashService = AirtimeCashService;
//# sourceMappingURL=airtime-cash.service.js.map